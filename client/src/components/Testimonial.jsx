...
export const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      id: 1,
      name: "Yassine Ben Ammar",
      role: "Senior Developer at TechFlow",
      content: `Working with Mohamed Ali was a great experience. His ability to architect full-stack solutions with both MERN and Laravel shows real versatility. He communicates clearly and delivers clean, well-structured code every time.`,
      rating: 5,
      image: ""
    },
    {
      id: 2,
      name: "Amira Khaldi",
      role: "UX Lead at DesignLab",
      content: `Mohamed Ali has an exceptional eye for UI detail. The way he translates Figma designs into pixel-perfect React components while maintaining performance is impressive. His SocraticAI project shows real innovation in UX thinking.`,
      rating: 5,
      image: ""
    },
    {
      id: 3,
      name: "Omar Hammami",
      role: "Project Manager at DataWave",
      content: `From architecture to deployment, Mohamed Ali handled every aspect with confidence. His Expense Tracker project demonstrated solid Laravel API design and seamless React integration. A developer you can rely on.`,
      rating: 5,
      image: ""
    },
  ];
