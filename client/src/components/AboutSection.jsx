...
export const AboutSection = () => {
  ...
  const achievements = [
    ...
    { number: "3", label: "Years Learning", icon: <Calendar className="h-5 w-5" />, suffix: "+" },
    { number: "AI", label: "Focus Area", icon: <Target className="h-5 w-5" />, suffix: "" },
    { number: "5", label: "Technologies", icon: <User className="h-5 w-5" />, suffix: "+" }
  ];

  const techStack = [
    { category: "Frontend", items: ["React.js", "Next.js", "Tailwind CSS", "JavaScript", "HTML5"] },
    { category: "Backend", items: ["Node.js", "Express.js", "Laravel", "PHP", "Java"] },
    { category: "Database", items: ["MongoDB", "MySQL", "PostgreSQL"] }
  ];

  const features = ["MERN stack expertise", "Laravel & PHP development", "AI integration (OpenAI/GPT)", "RESTful API design", "Responsive UI/UX", "Clean, maintainable code"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/MohamedAliCH" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/mohamed-ali-chouchane-hmila-511ba8371" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:mohamedalitunisien@gmail.com" }
  ];

  const tabContent = {
    personal: "Software Engineering student at ISIMG, Tunisia, passionate about building intelligent web experiences. I love exploring how AI can enhance traditional applications and create meaningful tools for learning and productivity.",
    professional: "Experienced in full-stack development with MERN and Laravel stacks. I've built projects ranging from AI-powered tutoring platforms to real-time task management systems, always focused on clean architecture and scalable code.",
    approach: "I follow a principle of 'healthy friction' in development \u2014 building features that challenge users to grow, not just consume. My process emphasizes modular design, thorough testing, and user-centered thinking."
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/MohamedAli-resume.pdf';
    link.download = 'MohamedAli-resume.pdf';
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/profile-photo.png" alt="Mohamed Ali" className="w-full h-full object-cover object-top" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Mohamed Ali</h2>
