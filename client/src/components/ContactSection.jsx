...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mreraqaw', {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: "Please try again or email me directly at mohamedalitunisien@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/mohamed-ali-chouchane-hmila-511ba8371",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/MohamedAliCH",
                  },
                  {
                    icon: Mail,
                    label: "Email",
                    url: "mailto:mohamedalitunisien@gmail.com",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
