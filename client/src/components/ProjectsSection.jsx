...
const projects = [
  {
    ...
    description: "GPT-4o/Socket.IO tutor using Socratic dialogue and 'healthy friction' mechanics to build student cognitive autonomy. Features a real-time Autonomy Engine and AI Trap System.",
    image: "/projects/socraticai.png",
    video: "",
    tags: ["MERN Stack", "Socket.IO", "OpenAI GPT-4o", "Real-time"],
    demoUrl: "#",
    githubUrl: "https://github.com/MohamedAliCH/Studify",
    featured: true,
    accentColor: "from-violet-500 to-indigo-600",
    status: "Live",
    highlights: ["Autonomy Engine", "AI Trap System", "Adaptive Assistance Levels"]
  },
  {
    id: 2,
    title: "Task Dashboard",
    category: "Productivity",
    description: "Interactive task management system with drag-and-drop features for enhanced workflow organization. Leverages React state management for seamless, real-time UI updates.",
    image: "/projects/taskdashboard.png",
    video: "",
    tags: ["React", "State Management", "Drag & Drop", "Responsive"],
    demoUrl: "#",
    githubUrl: "https://github.com/MohamedAliCH/Task-dashboard-drag-drop",
    featured: true,
    accentColor: "from-blue-500 to-cyan-600",
    status: "Live",
    highlights: ["Drag & drop workflow", "Real-time updates", "Task organization"]
  },
  {
    id: 3,
    title: "Expense Tracker",
    category: "FinTech",
    description: "Full-stack financial tracking system using a Laravel API and React frontend. Implements secure data persistence with MySQL and streamlined API communication.",
    image: "/projects/expensetracker.png",
    video: "",
    tags: ["Laravel", "React", "MySQL", "REST API"],
    demoUrl: "#",
    githubUrl: "https://github.com/MohamedAliCH/expense-tracker",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["Financial tracking", "Laravel API", "Real-time balance"]
  },
  {
    id: 4,
    title: "Little Lemon",
    category: "Restaurant",
    description: "Responsive UI components translated from Figma designs into a modular, reusable React architecture. Focused on mobile-first design principles and efficient client-side routing.",
    image: "/projects/littlelemon.png",
    video: "",
    tags: ["React", "Figma", "Mobile-first", "Client-side Routing"],
    demoUrl: "#",
    githubUrl: "https://github.com/MohamedAliCH/Little-Lemon",
    accentColor: "from-amber-500 to-orange-600",
    status: "Live",
    highlights: ["Figma → React", "Responsive design", "Reusable components"]
  }
];

const categoryColors = {
  "Artificial Intelligence": "from-violet-500/20 to-indigo-600/20 text-violet-600 border-violet-500/30",
  "Productivity": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
  "FinTech": "from-emerald-500/20 to-teal-600/20 text-emerald-600 border-emerald-500/30",
  "Restaurant": "from-amber-500/20 to-orange-600/20 text-amber-600 border-amber-500/30"
};
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/MohamedAliCH"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
