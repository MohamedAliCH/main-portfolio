...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/mohamed-ali-chouchane-hmila-511ba8371", label: "LinkedIn" },
    { icon: <Github size={18} />, href: "https://github.com/MohamedAliCH", label: "GitHub" },
    { icon: <Mail size={18} />, href: "mailto:mohamedalitunisien@gmail.com", label: "Email" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "mohamedalitunisien@gmail.com", href: "mailto:mohamedalitunisien@gmail.com" },
    { icon: <MapPin size={16} />, text: "Tunisia" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">MOHAMED ALI</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Full-stack developer building intelligent web experiences.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Mohamed Ali. All rights reserved.</p>
            </div>
