...
const skills = [
  ...
  { name: "PHP", level: 80, category: "backend", icon: "java" },
  { name: "Laravel", level: 78, category: "backend", icon: "express" },
  { name: "Java", level: 70, category: "backend", icon: "java" },

  // Tools & Database
  { name: "MongoDB", level: 85, category: "tools", icon: "mongodb" },
  { name: "MySQL", level: 82, category: "tools", icon: "mysql" },
  { name: "PostgreSQL", level: 70, category: "tools", icon: "postgresql" },
  { name: "Git", level: 90, category: "tools", icon: "git" },
  { name: "GitHub", level: 90, category: "tools", icon: "github" },
  { name: "REST APIs", level: 88, category: "tools", icon: "graphql" },
];
